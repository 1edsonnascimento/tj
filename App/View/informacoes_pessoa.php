...
<?php
    ...
    if($_POST){
        ...
        $class = "class='animacaoServico w3-panel  w3-topbar w3-bottombar w3-yellow w3-center'";
        $class2 = "class='animacaoServico w3-panel w3-topbar w3-bottombar w3-grenn w3-center'";
        ...
        if($pub->getNome()==null || $pub->getCpf()==null) {
            ...
            if ($pd->alterar($pub))
                echo "<div ".$class2."><h5>Alteração Feita com sucesso!!</h5></div>";
        }
    }
    $pubDao = new App\Dao\UsuarioDao();
    $pub = new App\Model\Usuario();
    $pub->setIdUsuario($_SESSION['idLogin']);
    $u = $pubDao->pesquisar($pub);
?>
<div class="main">
<form class="w3-container" action="informacoes_pessoa.php" method="post">
    ...
    <p><textarea rows="3" id="obs" name="obs" placeholder="Observações" <?php echo $class;?>><?php echo $u['obs']; ?></textarea>
    </p>
